// Based on:
// https://github.com/kburchfiel/cpp_yf2dg_gd_4pt_6/blob/main/src/scene/hud.h
...
public:
  ...
  bool announce_winner = false; // When set to true, this boolean
  // prevents a new game from getting started--and thus allows
  // more time for results from the previous game to get displayed.
