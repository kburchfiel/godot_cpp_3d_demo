...
{show_message("Press Fire to launch a "+players_to_include_string+"-player game. Press left and right on Player 1's \
control stick to increase and decrease the \
